...
const LifeOutsidePage = () => {
    ...
    return (
        <section id="lifeOutside" className="section container mx-auto px-4">
            <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-center">{t('lifeOutside.title')}</h2>
            <p className="text-xl text-gray-300 text-center mb-12">{t('lifeOutside.subtitle')}</p>

            {/* Hobbies Section */}
            <div className="mb-16">
                <h3 className="text-2xl font-bold mb-6">{t('lifeOutside.hobbies')}</h3>
            ...
            {/* Cats Section */}
            <div>
                <h3 className="text-2xl font-bold mb-6">{t('lifeOutside.cats')}</h3>
